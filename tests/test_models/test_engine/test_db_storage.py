...
class test_DBStorage(unittest.TestCase):
    ...
    def test_dbstorage_user_attr(self):
        ...
        '''
        new = User(email="dannychris2@alx.com", password="hello")
        self.assertTrue(new.email, "dannychris2@alx.com")
    ...
    def test_dbstorage_delete(self):
        ...
        '''
        new_user = User(email="haha@hehe.com", password="123",
                        first_name="Daniel", last_name="Ogah")
